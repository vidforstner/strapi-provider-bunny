...
var ApplicationError = _utils.errors.ApplicationError;
...
var init = function init(_ref) {
  var api_key = _ref.api_key,
    storage_zone = _ref.storage_zone,
    pull_zone = _ref.pull_zone,
    region = _ref.region;
          ...
          function _callee$(_context) {
            while (1)
              switch ((_context.prev = _context.next)) {
                case 0:
                  data =
                    file.stream || _buffer.Buffer.from(file.buffer, 'binary');
                  checksum = (0, _index.generateChecksum)(data);
                  _context.prev = 2;
                  _context.next = 5;
                  return _axios['default'].put(
                    ''
                      .concat(region, '.storage.bunnycdn.com/')
                      .concat(storage_zone, '/')
                      .concat(file.hash)
                      .concat(file.ext),
                    data,
                ...
                case 5:
                  ...
                  throw new ApplicationError(
                    'Error uploading to Bunny.net: '.concat(
            ...
            while (1)
              switch ((_context2.prev = _context2.next)) {
                ...
                case 3:
                  ...
                  type = _mime['default'].getType(file.ext);
                  if (/^text(\/|$)/.test(type)) {
                ...
                case 9:
                  ...
                  throw new ApplicationError(
                    'Error downloading from Bunny.net: '.concat(
